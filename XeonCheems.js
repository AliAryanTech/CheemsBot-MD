...
//[target]\\
	const reply = (teks) => {
            XeonBotInc.sendMessage(m.chat, { text: teks, contextInfo:{"externalAdReply": {"title": ` ${global.botnma}`,"body": `Join Texas Bot Support Group`, "previewType": "PHOTO","thumbnailUrl": ``,"thumbnail": fs.readFileSync(`./XeonMedia/cheemspic.jpg`),"sourceUrl": "https://chat.whatsapp.com/F3ox61UsSkq6pBbVWuUCL4"}}}, { quoted: m})
        }
        
        const replay = (teks) => {
            XeonBotInc.sendMessage(m.chat, { text: teks, contextInfo:{"externalAdReply": {"title": ` ${global.botnma}`,"body": `Join our Anime Channel & Enjoy`, "previewType": "PHOTO","thumbnailUrl": ``,"thumbnail": fs.readFileSync(`./XeonMedia/cheemspic.jpg`),"sourceUrl": "https://t.me/AnimeListUp"}}}, { quoted: m})
        }
try {
...
*Urdu* : ${res.result.data.translation.urdu}
*Turkish* : ${res.result.data.translation.turkish}
...
case 'tes': case 'test': case 'alive': case 'bot': case 'robot': case 'cheems': case 'doge':{
                anu = `𝙃𝙚𝙡𝙡𝙤! ${pushname} 👀
𝙄'𝙢 𝙏𝙚𝙭𝙖𝙨 𝘽𝙤𝙩 \n𝙄 𝙡𝙤𝙫𝙚 𝙮𝙤𝙪 ${pushname} ❤️ \n𝙄 𝙬𝙖𝙣𝙩 𝙩𝙤 𝙨𝙩𝙖𝙮 𝙬𝙞𝙩𝙝 𝙮𝙤𝙪 𝙛𝙤𝙧𝙚𝙫𝙚𝙧!!`
...
const template = generateWAMessageFromContent(m.chat, proto.Message.fromObject({
                    templateMessage: {
                        hydratedTemplate: {
                            ...
                            locationMessage: {
                            jpegThumbnail: fs.readFileSync('./XeonMedia/cheemspic.jpg')},
                            hydratedFooterText: `𝙃𝙚𝙡𝙡𝙤! ${pushname} 👀
𝙔𝙚𝙨, 𝙒𝙝𝙖𝙩 𝙘𝙖𝙣 𝙄 𝙙𝙤 𝙛𝙤𝙧 𝙮𝙤𝙪??
...
𝙋𝙡𝙚𝙖𝙨𝙚, 𝙎𝙚𝙡𝙚𝙘𝙩 𝙖𝙣𝙮 𝙗𝙪𝙩𝙩𝙤𝙣 𝙗𝙚𝙡𝙤𝙬.
`,
                            hydratedButtons: [{
                                urlButton: {
                                    displayText: 'Telegram 🌀',
...
let template = await generateWAMessageFromContent(m.chat, proto.Message.fromObject({
                listMessage :{
                    title: `𝐇𝐞𝐥𝐥𝐨! ${pushname} 👀`,
                    description: `𝙋𝙡𝙚𝙖𝙨𝙚 𝙩𝙖𝙥 𝙤𝙣 𝙩𝙝𝙚 𝙈𝙚𝙣𝙪 𝙗𝙪𝙩𝙩𝙤𝙣 𝙖𝙣𝙙 𝙘𝙝𝙤𝙤𝙨𝙚 𝙖𝙣 𝙤𝙥𝙩𝙞𝙤𝙣.\n\n`,
                    buttonText: "Menu",
                    footerText: "_𝙃𝙚𝙘𝙠𝙚𝙧 𝙏𝙚𝙭𝙖𝙨_",
